...
class CitiesController extends Controller
{
    ...
    public function store(StoreCitiesRequest $request)
    {
        ...
        $city = City::create($this->getFormattedData($request->all()));
    ...
    public function update(UpdateCitiesRequest $request, $id)
    {
        ...
        $city->update($this->getFormattedData($request->all()));
    ...
    public function show($id)
    {
        ...
        $projects = \App\Project::where('city_id', $id)->get();

        $city = $this->findOrFailWithTranslation($id);

        return view('admin.cities.show', compact('city', 'projects'));
    }
    ...
    protected function findOrFailWithTranslation($id)
    {
        ...
        $city->name_ru = $city->translate(config('custom.language_ru'))->name;
        $city->name_en = $city->translate(config('custom.language_en'))->name;
