                    ...
                    @if (count($settings) > 0)
                        @foreach ($settings as $setting)
                            <tr data-entry-id="{{ $setting->id }}">
                                ...
                                <td>
                                    @can('setting_view')
                                    <a href="{{ route('admin.settings.show',[$setting->id]) }}" class="btn btn-xs btn-primary">@lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('setting_edit')
                                    <a href="{{ route('admin.settings.edit',[$setting->id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('setting_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
